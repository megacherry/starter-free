...
const LINE_HEIGHT = 1.219
export const createMontserratFont = <A extends GenericFont>(
  font: Partial<A> = {},
  {
  ...
  return createFont({
    family: isWeb
      ? 'var(--font-montserrat), -apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif'
      : 'Montserrat',
